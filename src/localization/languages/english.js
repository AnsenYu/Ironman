...
export default {
    ...
    //2
    [KEYS.ALERT_IdentityNameExists]: ['Identity Name Exists', 'This Identity name is registered to another Identity.'],
    //2
    [KEYS.ALERT_NoSuchIdentityName]: ['No such Identity name', 'This Identity name is not reserved in RIDL.'],
    //2
    [KEYS.ALERT_KeyPairExists]: ['Key Pair Exists', 'This Key Pair is already registered in your keychain.'],
    //2
    [KEYS.ALERT_BadKeyPairName]: ['Bad Key Pair Name', 'Key Pairs must be named uniquely.'],
    //2
    [KEYS.ALERT_InvalidPrivateKey]: ['Invalid Private Key', `The private key you entered seems to be invalid. Please check the key and try again.`],
    //2
    ...
    //2
    [KEYS.ALERT_PasswordsDoNotMatch]: ['Passwords Do Not Match', `The password you entered does not match it's confirmation.`],
    //2
    [KEYS.ALERT_BadPassword]: ['Bad Password', 'Passwords must be at least 8 characters long'],
    //2
    [KEYS.ALERT_WrongPassword]: ['Wrong Password', 'The password you entered was incorrect.'],
    //2
    ...
    //2
    [KEYS.ALERT_RemovingEndorsedNetwork]: ['Cannot Remove Endorsed Network', `You cannot remove Fiberman's endorsed Networks.`],
    //2
    ...
    //2
    [KEYS.PROMPT_DestroyingScatter]: ['Destroying Fiberman', 'This is your last chance to double check your backups.'],
    //2
    ...
    //2
    [KEYS.PROMPT_RevokingContractAction]: domain => ['Revoking Contract Action', `You are about to revoke an action from ${domain}`],
    //2
