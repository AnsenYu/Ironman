...
export default class EOS extends Plugin {
    ...
    privateToPublic(privateKey){ return ecc.privateToPublic(privateKey, "EOS"); }
    validPrivateKey(privateKey){ return ecc.isValidPrivate(privateKey); }
    validPublicKey(publicKey){   return ecc.isValidPublic(publicKey, "EOS"); }
    ...
    async getBalances(account, network, code = 'eos.token', table = 'accounts'){
